/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e6fac90e630c4575937284bb8fe07ddc)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	APP_NAME: "Mailcove Staging" | "Mailcove";
	APP_BASE_URL: "https://mailcove-staging.neil27.workers.dev" | "http://localhost:5173";
	EMAIL_WORKER_NAME: "mailcove-staging" | "mailcove";
	DEFAULT_MAIL_PROVIDER: "cloudflare";
	UNDO_SEND_SECONDS: "10";
	MAIL_HUB: DurableObjectNamespace<import("./src/worker/index").MailHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "MailHub";
	}
	interface StagingEnv {
		...
		WEBHOOK_RATE_LIMITER: RateLimit;
		ASSETS: Fetcher;
		APP_NAME: "Mailcove Staging";
		APP_BASE_URL: "https://mailcove-staging.neil27.workers.dev";
		EMAIL_WORKER_NAME: "mailcove-staging";
		DEFAULT_MAIL_PROVIDER: "cloudflare";
		UNDO_SEND_SECONDS: "10";
		MAIL_HUB: DurableObjectNamespace<import("./src/worker/index").MailHub>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "APP_BASE_URL" | "EMAIL_WORKER_NAME" | "DEFAULT_MAIL_PROVIDER" | "UNDO_SEND_SECONDS">> {}
}
